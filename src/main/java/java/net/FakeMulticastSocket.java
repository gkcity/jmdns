...
public class FakeMulticastSocket extends DatagramSocket {

    private boolean interfaceSet;
    private final Object ttlLock;
    private final Object infLock;
    private InetAddress infAddress;

    public FakeMulticastSocket() throws IOException {
        this(new InetSocketAddress(0));
    }

    public FakeMulticastSocket(int var1) throws IOException {
        this(new InetSocketAddress(var1));
    }

    public FakeMulticastSocket(SocketAddress var1) throws IOException {
